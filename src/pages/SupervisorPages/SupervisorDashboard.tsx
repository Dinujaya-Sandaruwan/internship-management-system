      ...
      {supervisor.profileCompletion < 80 && (
        <div className="dashboard__alert supervisor-alert">
          ...
          <div className="dashboard__alert-content">
            ...
            <p>
              Your profile is only {supervisor.profileCompletion}% complete. You
              need to complete at least 80% of your profile to access all system
              features and send supervision requests to interns.
            </p>
            <button
              className="dashboard__alert-button"
              onClick={() => {
                // Use navigate here to go to update profile page
                window.location.href =
                  "/supervisor/update-profile?menu=updateProfile";
              }}
            >
                  ...
                  <div className="request-form">
                    ...
                    {requestSent && (
                      <div className="request-success">
                        ...
                        Request sent successfully! The student will be notified.
                      </div>
                    )}
                  </div>
                </div>
